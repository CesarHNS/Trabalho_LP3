...
public class TelaLogin extends JFrame {
	...
	public TelaLogin() {
		setResizable(false);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//fecha todas as janelas quando clico no X
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				//if( txtLogin.getText().equals("admin") && txtPassword.getText().equals("123")){
					TelaControle ObjTelaControle = new TelaControle();
					ObjTelaControle.setVisible(true);
					
			/*	}else{
					JOptionPane.showMessageDialog(null, "Sua senha ou seu login estão incorretos");
				}
					*/
